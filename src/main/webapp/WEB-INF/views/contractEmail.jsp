        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Lista pracowników pasujących do kontraktu ${contract.name}</h1>
                </div>
                    ...
                    <table cellspacing="0" cellpadding="0" border="1" style="width: 100%;">
                        ...
                        <c:forEach items="${workers}" var="worker">
                            <tr>
                                ...
                                <td>
                                    <a href="/email/sendEmail?id=${worker.id}" class="btn btn-danger rounded-0 text-light m-1">Powiadom o kontrakcie</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
