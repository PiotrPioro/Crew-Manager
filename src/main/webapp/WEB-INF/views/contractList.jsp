            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <table cellspacing="0" cellpadding="0" border="1" style="width: 100%;">
                        <thead>
                        <tr>
                            <th>Nazwa kontraktu</th>
                            <th>Miejsce kontraktu</th>
                            <th>Akcja</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${contracts}" var="contract">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/contract/deleteContract?id=${contract.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń kontrakt</a>
                                    <a href="/contract/showContract?id=${contract.id}" class="btn btn-danger rounded-0 text-light m-1">Pokaż kontrakt</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
