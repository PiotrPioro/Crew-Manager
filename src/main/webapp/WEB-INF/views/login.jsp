                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form action="/crewManager/login" method="post" class="user">
                                    <div class="form-group">
                                        <input name="username" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Podaj email"/>
                                    </div>
                                    <div class="form-group">
