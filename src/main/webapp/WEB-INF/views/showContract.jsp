        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Kontrakt ${contract.name}</h1>
                </div>

                <!-- Content Row -->
                <div class="row">
                    <p class="h3 mb-0 text-gray-800">
                        Miejsce kontraktu: ${contract.place} <br>
                        Nazwa firmy: ${contract.name} <br>
                        Osoba do kontaktu: ${contract.contactName} <br>
                        Numer telefonu do osoby kontaktowej: ${contract.contactPhoneNumber} <br>
                        Początek kontraktu: ${contract.startDate} <br>
                        Koniec kontraktu: ${contract.endDate} <br>
                    </p>
                </div>
                        ...
                        <tbody>
                            <c:forEach var="worker" items="${workers}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/email/sendEmail?contractId=${contract.id}&workerId=${worker.id}">Wyślij maila</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
