                    ...
                    <table cellspacing="0" cellpadding="0" border="1" style="width: 100%;">
                        ...
                        <c:forEach items="${workers}" var="worker">
                            <tr>
                                ...
                                <td>
                                    <a href="/worker/editWorker?id=${worker.id}" class="btn btn-danger rounded-0 text-light m-1">Edytuj dane pracownika</a>
                                    <a href="/worker/deleteWorker?id=${worker.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń dane pracownika</a>
                                    <a href="/worker/showWorker?id=${worker.id}" class="btn btn-danger rounded-0 text-light m-1">Pokaż dane pracownika</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
